...
from hand_sign_detection.entity.config_entity import DataValidationConfig
from hand_sign_detection.entity.artifacts_entity import *
from hand_sign_detection.constant import *
