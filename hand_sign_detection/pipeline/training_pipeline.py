...
from hand_sign_detection.components.model_trainer import ModelTrainer
...
from hand_sign_detection.entity.config_entity import DataIngestionConfig, DataValidationConfig, ModelTrainerConfig
